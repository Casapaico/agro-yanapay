    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('super_admin', 'Super Administrador'), ('community_admin', 'Administrador Comunitario'), ('data_analyst', 'Analista de Datos'), ('viewer', 'Solo Lectura')], default='community_admin', max_length=20)),
